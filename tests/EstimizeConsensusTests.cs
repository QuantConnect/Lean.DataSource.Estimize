...
{
    [TestFixture]
    public class EstimizeConsensusTests
    {
        [Test]
        ...
        private BaseData CreateNewInstance()
        {
            return new EstimizeConsensus
            {
                ...
                Source = EstimizeConsensus.ConsensusSource.Estimize,
                Type = null,
                Mean = 0.5m,
                High = 1m,
                Low = 0.2m,
                ...
                Count = 10,
                UpdatedAt = new DateTime(2021, 6, 29, 12, 0, 0),
                FiscalYear = 2021,
                FiscalQuarter = 4
            };
        }
