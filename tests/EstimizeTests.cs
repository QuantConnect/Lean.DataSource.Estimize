    ...
    public class EstimizeTests
    {
        ...
        public void SerializeRoundTripEstimizeConsensus()
        {
            ...
            var item = new EstimizeConsensus
            {
                ...
                FiscalYear = 2020,
                FiscalQuarter = 1,
                Source = EstimizeConsensus.ConsensusSource.WallStreet,
                Type = EstimizeConsensus.ConsensusType.Eps,
                Count = 3,
                Mean = 2,
                UpdatedAt = time
            };
            ...
            Assert.AreEqual(2020, deserialized.FiscalYear);
            Assert.AreEqual(1, deserialized.FiscalQuarter);
            Assert.AreEqual(EstimizeConsensus.ConsensusSource.WallStreet, deserialized.Source);
            Assert.AreEqual(EstimizeConsensus.ConsensusType.Eps, deserialized.Type);
